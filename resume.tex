...
\begin{center}
    {\textbf{\Huge \scshape Akshat Aggarwal}} \\ \vspace{5pt}
...
\experienceItem{Intuit}{Bengaluru, India}{Software Engineer 1}{Aug 2024 - Present}{
    \begin{itemize}
        \item Contributing to the development of multi-entity aware dimensions for \textbf{Intuit Enterprise Suite} (IES), simplifying financial management for \textbf{mid-market businesses}.
...
\playstoreProjectItem{Cardiocare}{Node.js, React, Express, MongoDB, Swagger UI, Flutter}{https://play.google.com/store/apps/details?id=com.cardio.care}{
    \item Led \textbf{backend development} for Cardiocare, an app designed for doctors at \textbf{IGMC Shimla}, to optimize patient care and medical record management.
