...
\experienceItem{Salesforce}{Bengaluru, India}{Associate Member of Technical Staff}{Jun 2024 - Aug 2024}{
    \begin{itemize}
        \item Enhanced the onboarding experience for core engineers in the Industries Cloud by creating better documentation.
        \item Helped draft a guide to aid new MuleSoft developers to help them start contributing quickly.
    \end{itemize}
}
\bulletSep
